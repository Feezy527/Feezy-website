...
document.querySelector('.js-periodic-table').innerHTML = elementsHTML;
...
document.querySelectorAll('.symbol')
    .forEach((symbol) => {
        symbol.addEventListener('click', () => {
            ...
            document.querySelector('.js-periodic-table').style.backgroundColor = "rgba(0,0,0,0.4)";
            let sidenavHTML = '';
            elements.forEach((element) => {
                if (symbol.innerHTML == element.symbol) {
                    sidenavHTML += ` 
                    <div class="element-container js-element-container">
                        <div class ="element-symbol"><b>${element.symbol}</b></div>
                        <h4 class="ele">Name: ${element.name}</h4>
                        <div class="element-info1">
                            <p class="num"><b>Atomic Number: </b>${element.atomicNumber}</p>
                            <p class="num"><b>Atomic Mass: </b>${element.atomicMass}</p>
                        </div>
            ...
            closeBtn.addEventListener('click', () => {
                document.querySelector('.element-container').style.display = 'none';
                document.querySelector('.js-periodic-table').style.backgroundColor = 'white';
            })
        })
    })